...
def get_documents_from_slack_data(path):
    ...
    print("@@@ type(documents[1])", type(documents[1]))
    print(documents[1])
    return documents
...
if __name__ == "__main__":
    # slack conversations
    slack_conversation_documents = get_documents_from_slack_data("/mnt/c/code/dev/ask-union-data/slack_conversation.zip")
    # flyte rst
    flyte_rst_documents = get_documents_from_rst_data("/mnt/c/code/dev/union-assistant/data/github/flyte")
    # flytesnacks (mostly for integration examples)
    flytensacks_documents = get_documents_from_python_data("/mnt/c/code/dev/union-assistant/data/github/flytesnacks")
    # flytekit python
    flytekit_python_documents = get_documents_from_python_data("/mnt/c/code/dev/union-assistant/data/github/flytekit")
    # flyteidl
    flyteidl_documents = get_documents_from_proto_data("/mnt/c/code/dev/union-assistant/data/github/flyte")
    """
    - datacatalog
    - flytecopilot
    - flytestdlib
    ...
    - flyteadmin
    """
    flyte_backend_documents = get_documents_from_golang_data("/mnt/c/code/dev/union-assistant/data/github/flyte")
    # flytectl
    flytectl_documents = get_documents_from_golang_data("/mnt/c/code/dev/union-assistant/data/github/flytectl")
