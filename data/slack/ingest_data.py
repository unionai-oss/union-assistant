...
if __name__ == "__main__":
    ...
    slack_documents = get_documents_from_slack_data("/mnt/c/code/dev/ask-union-data/slack_conversation.zip")
    rst_documents = get_documents_from_rst_data("/mnt/c/code/dev/union-assistant/data/github/flyte")

    
    # print("slack_documents", len(slack_documents))
    # vector_store =  embed_and_vectorize_documents(slack_documents[0])
    # print(vector_store)
    
    print("rst_documents", len(rst_documents))
    print(rst_documents)
